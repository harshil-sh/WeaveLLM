...
/// <summary>
/// Thread-safe test double for <see cref="IStreamingChatModel"/>.
/// Configurable for fixed responses and failure injection.
/// </summary>
public sealed class MockChatModel : IStreamingChatModel
{
    ...
    /// <summary>
    /// Creates a mock that always returns <paramref name="fixedResponse"/>,
    /// or propagates <paramref name="errorToReturn"/> as a failure result.
    /// </summary>
